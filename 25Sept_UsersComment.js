...
// let r1 = users.filter((id) => {
//   if(id.firstName == "Madison" && id.lastName == "Marshall")
//     return id.id;
// });
// console.log(r1);
...
// let r1 = users.find((val) => val.firstName =="Madison" && val.lastName == "Marshall").id;
// console.log(r1);
//===========================================================================
// 2) Who wrote the first comment (assuming the first comment is in position 0 of the comments array)

// let r2 = users.find((e) => e.id == comments[0].userId);
// console.log(r2);
//==========================================================================
// 3) Which user commented 'OK great thanks'?
// let r3 = users.find((e) => e.id ==comments.find((uid) => uid.text == "OK great thanks").userId);
// console.log(r3);
//========================================================================
// 4) Add the user's first and last name to each comment in the comments array
// let r4 = comments.map((comment) => {
...
let re5 = users.filter((user) => comments.find((comment) => comment.userId == user.id));// who commented
let r5 = users.filter((user) => !comments.find((comment) => comment.userId == user.id));
console.log(r5);
